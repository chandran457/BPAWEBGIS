...
lyr_geomorphology2_2.set('fieldLabels', {'fid': 'no label', 'NAME': 'header label - visible with data', 'TYPE1': 'no label', 'TYPE2': 'no label', });
lyr_junctions1_3.set('fieldLabels', {'fid': 'no label', 'Id': 'no label', 'Jn_Name': 'header label - always visible', 'District': 'no label', 'Name': 'no label', });
lyr_railways_4.set('fieldLabels', {'fid': 'no label', 'osm_id': 'no label', 'name': 'no label', 'type': 'no label', });
lyr_hospitals_5.set('fieldLabels', {'id': 'no label', 'Hospitals': 'header label - always visible', });
lyr_roads_6.set('fieldLabels', {'fid': 'no label', 'NAME': 'header label - always visible', 'Length': 'no label', });
